    ...
    namespace YeelightAPI
{
    ...
    bool Bulb::TestConnection() // Test connection member function
    {
        ...
        bacommand1.append(command1.toUtf8());
        bacommand2.append(command2.toUtf8());
    ...
    bool Bulb::SetPower(bool power, QString effect, int duration) // SetPower member function
    {
        ...
        if (power)
        {
            command = "{\"id\":2,\"method\":\"set_power\",\"params\":[\"on\",\"smooth\",500]}\r\n";
        }
        else
        {
            command = "{\"id\":2,\"method\":\"set_power\",\"params\":[\"off\",\"smooth\",500]}\r\n";
        }
        // Assemble command

        QByteArray bacommand;
        bacommand.append(command.toUtf8()); // Append command into bacommand
    ...
    bool Bulb::Toggle() // Toggle member function
    {
        ...
        QByteArray bacommand;
        bacommand.append(command.toUtf8());
    ...
    bool Bulb::SetRGB(int red, int green, int blue, QString effect, int duration) // SetRGB member function
    {
        ...
        QString command = "{\"id\":4,\"method\":\"set_rgb\",\"params\":[" + QString::number(RGB) + ",\"" + effect + "\"," + QString::number(duration) + "]}\r\n\r\n\r\n";
        QByteArray bacommand;
        bacommand.append(command.toUtf8());
